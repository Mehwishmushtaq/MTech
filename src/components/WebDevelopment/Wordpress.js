                    ...
                    <Row>
                        <Col md={6}>
                            ...
                            <Container id="features" className="mt-5">
                                <h5 className='mb-4'>It offers to manage;</h5>
                                {/* First row of features */}
                                <Row className="mb-4">
                                    <Col md={6}>
                                        <h7><FaWordpress className="mr-2" /> WordPress Module</h7>
                                    </Col>
                                    <Col md={6}>
                                        <h7><AiOutlineSearch className="mr-2" /> Content For SEO</h7>
                                    </Col>
                                     <Col md={6}>
                                        <h7><DiGoogle className="mr-2" /> Google Rankings</h7>
                                    </Col>
                                    <Col md={6}>
                                        <h7><IoMdGlobe className="mr-2" /> Web-Based Interface</h7>
                                    </Col>
                                </Row>
